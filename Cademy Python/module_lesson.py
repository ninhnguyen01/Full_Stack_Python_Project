...
month=2, day=16)
feb_16_2019_v2= datetime.date(2019, 2, 16)
print(feb_16_2019) #2019-02-16

time_13_48min_5sec = datetime.time(hour=13, minute=48,
second=5)
time_13_48min_5sec_2 = datetime.time(13, 48,
5)
...
second=5)
timestamp_2 = datetime.datetime(2019, 2, 16,
13, 48, 5)
...
# Returns a random integer N in a givenrange, such that start <= N <= end
